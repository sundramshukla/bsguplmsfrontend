...
const AdminLessons = () => {
  ...
  const fetchLessons = async () => {
    setLoading(true);
    try {
      const res = await fetch(`https://bsguplmps.pythonanywhere.com/bsgupadmin/create-lesson/?course_id=${selectedCourseId}`);
      const data = await res.json();
      if (data.success && data.data) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://bsguplmps.pythonanywhere.com/bsgupadmin/create-lesson/', {
        method,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://bsguplmps.pythonanywhere.com/bsgupadmin/create-lesson/?lesson_id=${id}`, {
        method: 'DELETE'
      });
      const data = await res.json();
      if (data.success) {
