        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="border border-slate-200 shadow-lg rounded-2xl bg-slate-50 p-3 overflow-x-auto">
            <div 
              ...
              className={`w-[650px] min-h-[460px] mx-auto border-[10px] bg-white p-3 box-border text-center flex flex-col justify-center items-center ${
                config.bgImageBase64 ? 'border-none' : 'border-amber-400'
              }`}
            >
              {config.bgImageBase64 ? (
                /* Uploaded Certificate Template Image: only overlay the student name */
                <div className="w-full flex flex-col justify-center items-center py-16">
                  <h1 
                    className="text-4xl font-serif font-black underline decoration-double decoration-amber-400 px-4 drop-shadow-sm"
                    style={{ color: config.textColor || '#1e293b' }}
                  >
                    Sundram Shukla
                  </h1>
                  <p className="text-xs font-bold text-slate-700 mt-2">
                    District: <span className="font-extrabold">GORAKHPUR</span>
                  </p>
                  <div className="text-[10px] font-mono font-bold text-amber-900 bg-amber-100/90 border border-amber-300 px-3 py-0.5 rounded mt-3">
                    Certificate No: CERT-2026-D89E619B35
                  </div>
                </div>
              ) : (
                /* Classic Layout Fallback */
                <div className="border-4 border-dashed border-slate-900/10 rounded-lg p-6 flex flex-col justify-between min-h-[420px] flex-grow w-full">
